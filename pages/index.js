...
const LoveJourneyFinal = () => {
  ...
  const sections = [
    ...
    {
      title: "Pra Sempre",
      text: "Vc é minha vida, meu amor, meu presente divino, te amo para todo sempre. Vamos conquistar tudo que queremos, seu concurso, nossa casa, nosso carro... O futuro é lindo ao seu lado.",
      icon: <Rocket size={48} />,
      color: "bg-white/20",
    },
  ];
  ...
  return (
    <div
      className="min-h-screen w-full bg-[#ff0055] text-white overflow-x-hidden selection:bg-white selection:text-rose-600"
    ...
    >
      ...
      <div className="relative z-10 w-full">
        ...
        >
          ...
          <p className="text-[6vw] font-bold opacity-90 mt-4 italic">
            Um dos desafios iniciais do meu novo curso é fazer algo que impacte
            alguém muito importante para vc, e não teria como eu não pensar em
            fazer uma declaração para vc de primeiro projeto :)...
          </p>
          ...
          {!showSurprise ? (
            ...
            >
              ...
              <span className="text-[4vw] font-bold uppercase tracking-widest flex items-center gap-2">
                <Play fill="currentColor" size={20} /> Veja um surpresa pra
                vc...
              </span>
            </motion.button>
          ) : (
        ...
        <footer className="bg-white/10 backdrop-blur-md p-16 text-center rounded-t-[4rem] border-t-2 border-white/20">
          ...
          <p
            className="text-[8vw] leading-none mb-6 italic"
            style={{ fontFamily: "'Great Vibes', cursive" }}
          >
            Quero que essa página, seja cada vez mais alimentada com meu amor,
            declarações, projetos nossos, comemorar datas importantes, pode até
            virar uma site do casal hehe, Te amo muito...
          </p>
